...
quantityImportantCoefs = 0


def main(m, n):
    global quantityImportantCoefs
    if n == 8:
        print(
    ...
    if n == 8:
        t = PrettyTable(
            ['N', 'norm_x_0', 'norm_x_1', 'norm_x_2', 'norm_x_3', 'norm_x_1_x_2', 'norm_x_1_x_3', 'norm_x_2_x_3',
             'norm_x_1_x_2_x_3', 'x_1', 'x_2', 'x_3', 'x_1_x_2', 'x_1_x_3', 'x_2_x_3', 'x_1_x_2_x_3'] + [f'y_{i + 1}'
                                                                                                         for i in
                                                                                                         range(m)] + [
                'y_av'])
        for i in range(n):
    ...
    if f_p > FishersTable[f_3][f_4]:
        print(
            f"fp = {f_p} > ft = {FishersTable[f_3][f_4]}.\nThe mathematical model is not adequate to the experimental "
            f"data\nStart again with m = m + 1")
        main(m=m + 1, n=8)
    else:
        print(
